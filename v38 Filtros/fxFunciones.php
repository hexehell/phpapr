...
function fnEchoClases($sClases, $sTexto)
{


echo "<p class='$sClases'>$sTexto</p>";

}

function fnEcho($sTexto)
{
	fnEchoClases("",$sTexto);
...
function fnToUpper(&$sCadena)
{
	$sCadena= strtoupper($sCadena);

}

function fnToLower(&$sCadena)
{
...
function fnToCapital(&$sCadena)
{

	$sCadena= ucfirst($sCadena);
}
